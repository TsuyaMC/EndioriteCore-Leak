...
class EndiumNugget extends Tool implements ItemComponents {

    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier, string $name = "Unknown") {
        parent::__construct($identifier, $name);
        $this->initComponent("endium_nugget", 1, new CreativeInventoryInfo(CreativeInventoryInfo::CATEGORY_ITEMS));
