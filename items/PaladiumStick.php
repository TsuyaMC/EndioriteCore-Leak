...
class PaladiumStick extends Tool implements ItemComponents {

    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier, string $name = "Unknown") {
        parent::__construct($identifier, $name);
        $this->initComponent("paladium_stick", 1, new CreativeInventoryInfo(CreativeInventoryInfo::CATEGORY_ITEMS));
