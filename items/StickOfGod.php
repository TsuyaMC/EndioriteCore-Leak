...
class StickOfGod extends Tool implements ItemComponents {

    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier, string $name = "Unknown") {
        parent::__construct($identifier, $name);
        $this->initComponent("stick_of_god", 1, new CreativeInventoryInfo(CreativeInventoryInfo::CATEGORY_ITEMS));
