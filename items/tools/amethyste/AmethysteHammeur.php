...
class AmethysteHammeur extends Pickaxe implements ItemComponents
{
    ...
    public function __construct(ItemIdentifier $identifier, string $name = "Unknown")
    {
        ...
        $this->initComponent("amethyst_hammer", 1, new CreativeInventoryInfo("equipment", "itemGroup.name.pickaxe"));
