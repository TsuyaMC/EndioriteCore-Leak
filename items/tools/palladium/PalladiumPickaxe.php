...
class PalladiumPickaxe extends Pickaxe implements ItemComponents {
    ...
    public function __construct(ItemIdentifier $identifier, string $name = "Unknown") {
        ...
        $this->initComponent("paladium_pickaxe", 1, new CreativeInventoryInfo("equipment", "itemGroup.name.pickaxe"));
