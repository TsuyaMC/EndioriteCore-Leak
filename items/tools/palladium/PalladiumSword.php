...
class PalladiumSword extends Sword implements ItemComponents {
    ...
    public function __construct(ItemIdentifier $identifier, string $name = "Unknown") {
        ...
        $this->initComponent("paladium_sword", 1, new CreativeInventoryInfo("equipment", "itemGroup.name.sword"));
        $this->addProperty("hand_equipped", true);
        $this->addProperty("damage", Main::$instance->utils::PALLADIUM_SWORD_DAMAGE);
