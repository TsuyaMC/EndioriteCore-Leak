...
class TitaneSword extends Sword implements ItemComponents {
    ...
    public function __construct(ItemIdentifier $identifier, string $name = "Unknown") {
        ...
        $this->initComponent("titane_sword", 1, new CreativeInventoryInfo("equipment", "itemGroup.name.sword"));
        $this->addProperty("hand_equipped", true);
        $this->addProperty("damage", Main::$instance->utils::TITANE_SWORD_DAMAGE);
