...
class TitaneHammer extends Pickaxe implements ItemComponents
{
    ...
    public function __construct(ItemIdentifier $identifier, string $name = "Unknown")
    {
        ...
        $this->initComponent("titane_hammer", 1, new CreativeInventoryInfo("equipment", "itemGroup.name.pickaxe"));
    ...
    public function getMaxDurability(): int
    {
        ...
        // TODO: Implement getMaxDurability() method.
    }
                    ...
                    if (!$block instanceof Bedrock && !$block instanceof Air) {
                        ...
                        if ($this->getNamedTag()->getInt("smelt", 0) === 1) {
                            foreach (BlockListener::getDrops($block) as $item) {
                                $blockWorld->dropItem($position, $item);
                            }
                        } else {
