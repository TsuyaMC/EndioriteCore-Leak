...
class EndioritePickaxe extends Pickaxe implements ItemComponents {
    ...
    public function __construct(ItemIdentifier $identifier, string $name = "Unknown") {
        ...
        $this->initComponent("azurite_pickaxe", 1, new CreativeInventoryInfo("equipment", "itemGroup.name.pickaxe"));
