...
class HammerSocket extends Tool implements ItemComponents {

    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier, string $name = "Unknown") {
        parent::__construct($identifier, $name);
        $this->initComponent("hammer_patern", 1, new CreativeInventoryInfo(CreativeInventoryInfo::CATEGORY_ITEMS));
