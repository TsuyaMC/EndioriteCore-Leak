...
class TitaneChestplate extends Armor implements ItemComponents {

    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier, string $name = "Unknown") {
        parent::__construct($identifier, $name, new ArmorTypeInfo(5, Main::$instance->utils::TITANE_TOOLS_DURABILITY, ArmorInventory::SLOT_CHEST));
        $this->initComponent("titane_chestplate", 1, new CreativeInventoryInfo("equipment", "itemGroup.name.chestplate"));
