...
class AmethysteLeggings extends Armor implements ItemComponents {

    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier, string $name = "Unknown") {
        parent::__construct($identifier, $name, new ArmorTypeInfo(5, Main::$instance->utils::AMETHYSTE_TOOLS_DURABILITY, ArmorInventory::SLOT_LEGS));
        $this->initComponent("amethiste_leggings", 1, new CreativeInventoryInfo("equipment", "itemGroup.name.leggings"));
