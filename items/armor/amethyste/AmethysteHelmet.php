...
class AmethysteHelmet extends Armor implements ItemComponents {

    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier, string $name = "Unknown") {
        parent::__construct($identifier, $name, new ArmorTypeInfo(5, Main::$instance->utils::AMETHYSTE_TOOLS_DURABILITY, ArmorInventory::SLOT_HEAD));
        $this->initComponent("amethiste_helmet", 1, new CreativeInventoryInfo("equipment", "itemGroup.name.helmet"));
