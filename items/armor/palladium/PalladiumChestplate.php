...
class PalladiumChestplate extends Armor implements ItemComponents {

    use ItemComponentsTrait;

    public function __construct(ItemIdentifier $identifier, string $name = "Unknown") {
        parent::__construct($identifier, $name, new ArmorTypeInfo(5, Main::$instance->utils::PALLADIUM_TOOLS_DURABILITY, ArmorInventory::SLOT_CHEST));
        $this->initComponent("paladium_chestplate", 1, new CreativeInventoryInfo("equipment", "itemGroup.name.chestplate"));
